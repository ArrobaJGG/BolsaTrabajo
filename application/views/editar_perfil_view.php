...
<div ng-controller="UserController">
	<form name="userForm" ng-submit="submit($event)" action="./Editar_perfil_controller" method="post" novalidate>
		Nombre: <input name="nombre"  type="text" ng-init= "nombre='<?php echo $nombre; ?>'" ng-model="user.nombre"  required />
		...
		Fecha Nacimiento: <input type="date" name="fecha" ng-init= "fecha='<?php echo $fecha; ?>'" ng-model="user.fecha" placeholder="fecha nacimiento" required>
		...
		Codigo Postal: <input type="text" name="codigopostal" ng-init= "codigopostal='<?php echo $codigo_postal; ?>'" ng-model="user.codigopostal" placeholder="38587" required>
		...
		Descripcion: <textarea name="descripcion" ng-init= "descripcion='<?php echo $descripcion; ?>'" ng-model="user.descripcion" ng-maxlength="1000" placeholder="introduce aqui..."  ng-maxlength="1000" required></textarea>
	...
	Año Inicio: <input type="number" name="ano_inicio" ng-init= "ano_inicio='<?php echo $ano_inicio; ?>'" ng-model="ano_incio"  min="1960" >
	...
	Año Fin: <input type="number" name="ano_fin" ng-init= "ano_fin='<?php echo $ano_fin; ?>'" ng-model="ano_fin" min="1980" >
	...
	Experiencia: <textarea name="experiencia" ng-init= "experiencia='<?php echo $experiencia; ?>'" ng-model="experiencia" ng-maxlength="1000" placeholder="experiencia..."></textarea>
